...
void RenderHUDModel(FModelRenderer *renderer, DPSprite *psp, FVector3 translation, FVector3 rotation, FVector3 rotation_pivot, FSpriteModelFrame *smf)
{
	...
	VSMatrix objectToWorldMatrix;
	renderer->PrepareRenderHUDModel(smf, translation, rotation, rotation_pivot, objectToWorldMatrix, smf_flags);
...
void FModelRenderer::PrepareRenderHUDModel(FSpriteModelFrame* smf, FVector3 translation, FVector3 rotation, FVector3 rotation_pivot, VSMatrix& objectToWorldMatrix, int smf_flags)
{
