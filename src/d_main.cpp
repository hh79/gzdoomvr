...
CVAR(Bool, autoloadlasersight, true, CVAR_ARCHIVE | CVAR_NOINITCALL | CVAR_GLOBALCONFIG)
...
void D_Cleanup()
{
	...
	GameStartupInfo.LoadWidescreen = GameStartupInfo.LoadLights = GameStartupInfo.LoadBrightmaps = GameStartupInfo.LoadLaserSight = -1;
