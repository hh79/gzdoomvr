...
public:
	...
	{}
	void PrepareRenderHUDModel(FSpriteModelFrame* smf, FVector3 translation, FVector3 rotation, FVector3 rotation_pivot, VSMatrix& objectToWorldMatrix, int smf_flags) override;
